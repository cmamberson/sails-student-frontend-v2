(function(){
  ...
  function deleteRecord(record_id){
    $("#deleteformGrade input[name=grade_id]").val(record_id);
  ...
  $(function(){
    ...
    addGradeButton.click(function(){
  	...
  	$("#gradeTable").on("click", "#editButtonGrade", function(e){
    ...
    $("#gradeTable").on("click", "#deleteButtonGrade", function(e){
      let recordId = $(this).data("gradeid")
      $("#deleteConfirmGrade").dialog({
