...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        return res.view(view, {courses: data});
    }).on('error', function (err) {
        return res.view(view, {error: { message: "There was an error getting the courses"}});
    });
  ...
  update: function (req, res) {
    ...
    client.put(endpoint + "/" + courseId, args, function (data, response) {
  ...
  delete: function (req, res) {
    ...
    client.delete(endpoint + "/" + req.body.course_id, function (data, response) {
